...
![段階的な透明化．a)初期はキートップをしっかり見える程度の透明度で表示．b)入力ミスの頻度が少ないキーは透明度を上げていき，最終的に完全に透明な状態になる．](../assets/system-gradually.png){#fig:gradually width=1.0\\linewidth}
...
InvisibleFlickは既存手法と比較してミスタップが減ったために，
使いやすく，今後も使用したいという印象を受けたと考えられる．
